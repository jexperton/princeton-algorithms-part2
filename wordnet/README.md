...
----------------------------------
1.3K Jan  4 23:06 Outcast.java
4.4K Jan  4 23:06 SAP.java
4.0K Jan  4 23:06 WordNet.java
...
% pmd .
*-----------------------------------------------------------
SAP.java:69: The private instance (or static) variable 'length' can be made 'final'; it is initialized only in the declaration or constructor. [ImmutableField]
...
Test 1b: check memory of WordNet object
  * synsets = synsets5000-subgraph.txt; hypernyms = hypernyms5000-subgraph.txt
    ...
    - student   memory              = 3769944 bytes
    - reference memory              = 7042736 bytes
    - student / reference ratio     = 0.5
    - maximum allowed rato          = 2.0
...
Test 1c: check memory of WordNet object
  * synsets = synsets10000-subgraph.txt; hypernyms = hypernyms10000-subgraph.txt
    ...
    - student   memory              = 9034840 bytes
    - reference memory              = 16173136 bytes
...
Test 2a-c: time length() and ancestor() with random pairs of vertices
  *  digraph-wordnet.txt
     -  reference solution calls per second:  728758.00
     -  student   solution calls per second:    1918.00
     -  reference / student ratio:               379.96
...
Test 3a-c: time length() and ancestor() with random subsets of 5 vertices
  *  digraph-wordnet.txt
     -  reference solution calls per second:  234281.00
     -  student   solution calls per second:    1709.00
     -  reference / student ratio:               137.09
...
Test 4a-c: time length() and ancestor() with random subsets of 100 vertices
  *  digraph-wordnet.txt
     -  reference solution calls per second:   15291.00
     -  student   solution calls per second:    1389.00
     -  reference / student ratio:                11.01
...
Test 6a-e: time sap() and distance() with random nouns
  * synsets = synsets.txt; hypernyms = hypernyms.txt
    - reference solution calls per second:  203563.75
    - student   solution calls per second:  223548.00
...
Test 7: time isNoun() with random nouns
  * synsets = synsets.txt; hypernyms = hypernyms.txt
    - reference solution calls per second: 1077393.00
    - student   solution calls per second:  852411.00
    - reference / student ratio:                 1.26
    - allowed ratio:                             4.00
==> passed
